...
from decoder_src.decode_attempt_3 import (
...
def main():
    ...
    parser.add_argument("--max_new_tokens_values", nargs="+", type=int, default=[36,48,96])
    ...
    def _run():
        run = wandb.init(project=args.project, entity=args.entity, dir='/gpfs/scratch/jn2691/NLP_RESULTS')
        cfg = run.config
